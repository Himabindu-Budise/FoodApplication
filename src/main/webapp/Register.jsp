	...
	<div class="container">
		...
		<form action="Register" method="post">
			<div class="form-group">
				<i class="bi bi-person"></i> <input type="text" name="username"
			...
			<div class="form-group">
				<i class="bi bi-envelope"></i> <input type="email" name="email"
					placeholder="Email" required>
			</div>
			<div class="form-group">
				<i class="bi bi-house"></i> <input type="text" name="address"
